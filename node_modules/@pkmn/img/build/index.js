...
var Data = new class {
  getPokemon(name) {
    ...
    return {
      ...
      backf: data.bf,
      bw: {
        front: (_a = data.bw) == null ? void 0 : _a.f,
        frontf: (_b = data.bw) == null ? void 0 : _b.ff,
        back: (_c = data.bw) == null ? void 0 : _c.b,
        backf: (_d = data.bw) == null ? void 0 : _d.bf
      }
    };
  }
  getItem(name) {
    const spritenum = DATA.items[toID(name)];
    return spritenum ? { spritenum } : void 0;
  }
  getAvatar(key) {
...
// src/index.ts
var Sprites2 = new (0, _chunkN2TORAPYjs.Sprites)(Data);
var Icons2 = new (0, _chunkN2TORAPYjs.Icons)(Data);



exports.Icons = Icons2; exports.Sprites = Sprites2;
